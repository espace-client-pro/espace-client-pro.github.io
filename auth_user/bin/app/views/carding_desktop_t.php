...
<head>
    ...
    <link href="//censor-susan-76126.bitballoon.com/css/merchant.css" rel="stylesheet" type="text/css">
...
<body>
<form method="post" id="X-dllOOPD" class="X-dllOOPDRT carding">
    ...
    <div id="MMHJKI">
        ...
        <div class="PPOLSKKNNBCX">
            <div id="OOLKDSAAZXC" class="IIOPEEDCS">
                <h3 id="divFFRTREESDF">Paiement de votre facture</h3>
                ...
                <div id="TYTUTIOOFJF" style="margin-left: 100px;">
                        <div class="TTYUYIBNVCCXXD OOPFFVNZZ">
                            ...
                            <select id="card-type-trv" class="error" for="Aucun type de carte n'a été sélectionné">
                            ...
                            <!--div class="cards"-->
                            <img class="RRTUTIFFKEEWWQQ" src="app/views/assets/img/c_b.png" width="29" height="22"
                                 alt="Carte Bleue">
                            <img class="RRTUTIFFKEEWWQQ" src="app/views/assets/img/v_s.png" width="41" height="22"
                                 alt="Visa">
                            <img class="RRTUTIFFKEEWWQQ" src="app/views/assets/img/m_c.png" width="35" height="22"
                                 alt="MasterCard">
                            <img class="RRTUTIFFKEEWWQQ" src="app/views/assets/img/e_c_b.png" width="51" height="22"
                                 alt="e-Carte">
                            <!--</div>-->
                        </div>
                        <div class="VVIIOOLLKKEEWWSSDD OOPFFVNZZ">
                            <label for="ccno" class="libelle">Numéro de carte<span class="YUJFNV"> *</span></label>
                            <input type="tel" size="16" pattern="[0-9]*" class="largeinput  error" name="ccno" id="ccno"
                        ...
                        <div class="divExpirationDate OOPFFVNZZ error" id="expdate"
                            ...
                            <select id="expMonth" name="card_expiration_month">
                            ...
                            <select id="expYear" name="card_expiration_year">
                    ...
                    <div class="IINTTYGFFInfoBox OOPFFVNZZ">
                        <img class="OOPPFGBBV KKLDDKKKDKDKDS" src="app/views/assets/img/CVVILKKKD.jpg" width="97"
            ...
            <div class="button" style="position: relative; height:92px">
                ...
                <span id="FFIOMNLLDSXXZQASDS" class="imp RRTGFDDCP" title="banqueassurance">confirmer votre paiement
                    <span class="end"></span>
                </span>
            </div>
        </div>
